...
import { gifDataThighs, videoDataThighs, 
         ...
         gifDataLats, videoDataLats,
         gifDataShoulder, videoDataShoulder,
         gifDataTriceps, videoDataTriceps,
         gifDataABS, videoDataABS,
         gifDataForearms, videoDataForearms } from "../json/jsonData"
            ...
            <Fragment>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-Video'>
                               { videoDataLats.map((videoitem,videokey) => {
                                   return(
                                   <div key={videokey} className='ex-VideoCard'>
                                       <div className='ex-VideoCard-Title'>
                                           <h3>{videoitem.title}</h3>
            ...
            <Fragment>
               ...
               <div className='ex-GIFContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-GIF'>
                               { gifDataBiceps.map((gifitem,gifkey) => {
                                   return(
                                   <div key={gifkey} className='ex-GifCard'>
                                       <div className='ex-GifCard-Title'>
                                           <h3>{gifitem.title}</h3>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                        <div className='ex-Video'>
                            { videoDataBiceps.map((videoitem,videokey) => {
                                return(
                                <div key={videokey} className='ex-VideoCard'>
                                    <div className='ex-VideoCard-Title'>
                                        <h3>{videoitem.title}</h3>
            ...
            <Fragment>
               ...
               <div className='ex-GIFContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-GIF'>
                               { gifDataTriceps.map((gifitem,gifkey) => {
                                   return(
                                   <div key={gifkey} className='ex-GifCard'>
                                       <div className='ex-GifCard-Title'>
                                           <h3>{gifitem.title}</h3>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-Video'>
                               { videoDataTriceps.map((videoitem,videokey) => {
                                   return(
                                   <div key={videokey} className='ex-VideoCard'>
                                       <div className='ex-VideoCard-Title'>
                                           <h3>{videoitem.title}</h3>
            ...
            <Fragment>
               ...
               <div className='ex-GIFContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-GIF'>
                               { gifDataShoulder.map((gifitem,gifkey) => {
                                   return(
                                   <div key={gifkey} className='ex-GifCard'>
                                       <div className='ex-GifCard-Title'>
                                           <h3>{gifitem.title}</h3>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-Video'>
                               { videoDataShoulder.map((videoitem,videokey) => {
                                   return(
                                   <div key={videokey} className='ex-VideoCard'>
                                       <div className='ex-VideoCard-Title'>
                                           <h3>{videoitem.title}</h3>
            ...
            <Fragment>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-Video'>
                               { videoDataABS.map((videoitem,videokey) => {
                                   return(
                                   <div key={videokey} className='ex-VideoCard'>
                                       <div className='ex-VideoCard-Title'>
                                           <h3>{videoitem.title}</h3>
            ...
            <Fragment>
               ...
               <div className='ex-GIFContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-GIF'>
                               { gifDataForearms.map((gifitem,gifkey) => {
                                   return(
                                   <div key={gifkey} className='ex-GifCard'>
                                       <div className='ex-GifCard-Title'>
                                           <h3>{gifitem.title}</h3>
               ...
               <div className='ex-VideoContent'>
                   <Row className='gx-0'>
                       ...
                       <Col xs={0} sm={0} md={8} lg={8} xl={8} xxl={8}>
                           <div className='ex-Video'>
                               { videoDataForearms.map((videoitem,videokey) => {
                                   return(
                                   <div key={videokey} className='ex-VideoCard'>
                                       <div className='ex-VideoCard-Title'>
                                           <h3>{videoitem.title}</h3>
