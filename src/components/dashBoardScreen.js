      ...
      <div className="MainContainer-dashboard">
        <div className="SubContainer-dashboard">
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to bottom, rgba(40, 48, 72, 1), rgba(28, 216, 210, 0.7)),url('../images/background0.jpg')",
            }}
          >
              ...
              <div className="db-cardmain-cont">
                <Row className="gx-0">
                  <Col
                    ...
                    xl={4}
                    xxl={4}
                    className="db-cardCol"
                  >
                    <div className="db-cardLeft"></div>
                  </Col>
                  <Col
                    xs={12}
                    sm={12}
                      ...
                      <Row className="gx-0">
                        <Col xs={12} sm={12} md={6} lg={5} xl={4} xxl={4}>
                          <div className="db-card-cont">
                            <div
                              className="db-card"
                              onClick={() => cardClick("Thighs")}
                            >
                              <img
                                src="../images/dumbbelllogo.gif"
                                alt="Logo"
                              ></img>
                              <h2>Thighs</h2>
                            </div>
