...
export const gifDataChest = [
        {
            title: 'Incline ChestPress 1',
            gif: '../images/chest/chest1.gif',
        },
        {
            title: 'Incline BenchPress Fly 2',
            gif: '../images/chest/chest2.gif',
        },
        {
            title: 'Flat ChestPress 3',
            gif: '../images/chest/chest3.gif',
        },
        {
            title: 'Flat Dumbbell Fly 4',
            gif: '../images/chest/chest4.gif',
        },
        {
            title: 'Dumbbell Pullover 5',
            gif: '../images/chest/chest5.gif',
        },
        {
            title: 'Close Grip BenchPress 6',
            gif: '../images/chest/chest6.gif',
        },
        {
            title: 'Flat Bar BenchPress 7',
            gif: '../images/chest/chest7.gif',
        },
        {
            title: 'Cable Up Chest Fly 8',
            gif: '../images/chest/chest8.gif',
        },
        {
            title: 'Cable Low Chest Fly 9',
            gif: '../images/chest/chest9.gif',
        },
        {
            title: 'Seated Chest Fly 10',
